...
if __name__ == "__main__":
    ...
    if inputs['run_optimization']:
        ...
        if isinstance(inputs['number_receivers'],list):
            ...
            rbound = inputs['number_receivers'].split('<=')
    ...
    if inputs['plot_results']:
        ...
        for iStage in range(len(stages)):
            ...
            satuTemp,nrmsTemp = remove_iReal_tt(satuBool,nrmsBool,stages[iStage].iReals,0)
            ...
            for iPlan in [ii[-2]]:
              ...
              for iReal in np.sort(list(detectableUndetected)):
                ...
                for it in range(satuTemp.shape[-1]):
                    ...
                    ax2.scatter(det,ttfd,s=20,c='lightgray')
                    ax2.scatter(det[iPlan],ttfd[iPlan],s=20,c='black')
