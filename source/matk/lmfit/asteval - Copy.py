...
class Interpreter:
  ...
  """
    ...
    supported_nodes = ('arg', 'assert', 'assign', 'attribute', 'augassign',
                       'binop', 'boolop', 'break', 'call', 'compare', 'constant',
    ...
    def run(self, node, expr=None, lineno=None, with_raise=True):
        ...
        except KeyError as err: # TODO This might be squashing the trace
    ...
    def on_constant(self, node): # ('value')
        'return constant'
        return node.value
